(() => {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".gallery-parts__slider")) new swiper_core_Swiper(".gallery-parts__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 4,
        ...
        if (document.querySelector(".content-article__slider")) new swiper_core_Swiper(".content-article__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 3,
        ...
        if (document.querySelector(".gallery-article__thumbs")) {
            const thumbsSwiper = new swiper_core_Swiper(".gallery-article__thumbs", {
                modules: [ Thumb ],
                observer: true,
                watchOverflow: true,
                observeParents: true,
            ...
            new swiper_core_Swiper(".gallery-article__slider", {
        ...
        if (document.querySelector(".interest__slider")) new swiper_core_Swiper(".interest__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 4,
